...
func main() {
	...
	// GLTF
	//f := MustGet(os.Open("./godel/demo/RubiksCube/RubiksCube_01.gltf")).(*os.File)
	f := MustGet(os.Open("./godel/demo/dice/dice.gltf")).(*os.File)
	defer f.Close()
	...
	app.Camera.LookFrom(mgl32.Vec3{-250, 0, 0})
